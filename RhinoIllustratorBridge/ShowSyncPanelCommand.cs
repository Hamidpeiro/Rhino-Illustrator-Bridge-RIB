...
namespace RhinoIllustratorBridge
{
    ...
    public class ShowSyncPanelCommand : Command
    {
        ...
        public override string EnglishName => "RhinoIllustratorBridge";
        ...
        protected override Result RunCommand(RhinoDoc doc, RunMode mode)
        {
            ...
            if (!isOpen)
            {
                ...
                RhinoApp.WriteLine("Rhino Illustrator Bridge panel opened.");
            }
            else
            {
                Panels.ClosePanel(panelId);
                RhinoApp.WriteLine("Rhino Illustrator Bridge panel closed.");
            }
